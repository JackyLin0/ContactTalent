...
public class TelAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            case 0: bm = BitmapFactory.decodeResource(res,R.mipmap.dept_customer); break;
            case 1: bm = BitmapFactory.decodeResource(res,R.mipmap.dept_factory); break;
            case 2: bm = BitmapFactory.decodeResource(res,R.mipmap.dept_employee); break;
        }
